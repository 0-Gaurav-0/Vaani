...
| P2-04 | Allowlisted shell commands          | `partial` | `feat/av-project-profile`    | P2-01                 | Project profile detection + `vaani.toml` overrides land first (T3.3); phrase→argv `commands.json` remains for global custom commands. No free-form shell from raw speech. |
