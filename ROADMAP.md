...
| P2-11 | Visual guide + first-result act     | `partial` | `explore/visual-computer-use` | P2-01, P2-05        | V0–V3 on explore branch: `guide.point`/`offer` (macOS overlay), `browser.result.open` structured + vision+click fallback. Win/Linux capture stubs; multi-display overlay + ScreenCaptureKit later (V4). Spec/plan: [visual-guide-act](docs/superpowers/specs/2026-07-27-visual-guide-act-design.md) |
