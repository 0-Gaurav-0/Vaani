...
def materialize_argv(
    ...
    *,
    ...
    if verb_name.startswith("window."):
        from vaani.verbs.packs.window import materialize_window_argv

        return materialize_window_argv(verb_name, slots, platform=platform)
